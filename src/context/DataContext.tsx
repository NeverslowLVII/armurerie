...
interface DataContextType {
  ...
  setIsPatronLoggedIn: React.Dispatch<React.SetStateAction<boolean>>;
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  const [selectedWeapon] = useState<Weapon | null>(null);
  const [isPatronLoggedIn, setIsPatronLoggedIn] = useState<boolean>(false);
