...
interface Props {
  ...
  readonly employees: Record<string, any>;
              ...
              <div className="flex flex-1 min-h-0">
                ...
                <div className="w-1/3 border-r border-gray-200 p-4 overflow-y-auto">
                  ...
                  <form onSubmit={editingEmployee ? handleEmployeeUpdate : handleAddEmployee} className="space-y-3">
                    ...
                    <div>
                      ...
                      >
                        <select
                          id="employeeRole"
                          value={tempRole}
                          onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setTempRole(e.target.value)}
                          className="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md"
                          required
                        >
                    ...
                    <div>
                      <label htmlFor="employeeColor" className="block text-sm font-medium text-gray-700 mb-1">
                        Couleur
                      </label>
                      <motion.div
                        initial="initial"
