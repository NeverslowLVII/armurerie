...
export function CreateUserDialog() {
	...
	return (
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
			...
			<DialogContent className="bg-background text-zinc-900 dark:bg-zinc-800 dark:text-zinc-100 sm:max-w-[425px]">
				<form onSubmit={onSubmit}>
					...
					<div className="grid gap-4 py-4">
						...
						<div className="grid gap-2">
							<Label htmlFor="color" className="dark:text-zinc-200">
								Couleur
							</Label>
							<Input
								id="color"
						...
						<div className="grid gap-2">
							<Label htmlFor="commission" className="dark:text-zinc-200">
								Commission (%)
							</Label>
							<Input
								id="commission"
						...
						<div className="grid gap-2">
							<Label htmlFor="contractUrl" className="dark:text-zinc-200">
								URL du contrat
							</Label>
							<Input
								id="contractUrl"
