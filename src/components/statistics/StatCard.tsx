...
const StatCard = ({ title, value, icon: Icon }: StatCardProps) => (
	<motion.div
		...
		className="relative overflow-hidden rounded-lg border border-zinc-200 bg-background p-3 shadow-lg backdrop-blur-xl transition-shadow duration-300 hover:shadow-xl dark:border-zinc-700 dark:bg-zinc-800"
