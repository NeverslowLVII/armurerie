    ...
    <>
      <AnimatePresence>
        <Dialog open={open} onOpenChange={onClose}>
          <div className="fixed inset-0 z-10 overflow-hidden flex items-center justify-center min-h-screen p-2">
            <motion.div
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    <div>
                      ...
                      <select
                        id="feedbackType"
                        value={type}
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setType(e.target.value as 'BUG' | 'FEATURE_REQUEST')}
                    ...
                    <div>
                      <label htmlFor="feedbackDescription" className="block text-sm font-medium text-gray-700 mb-1">
                        Description
                      </label>
                      <textarea
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
                            setStatus(e.target.value as 'OPEN' | 'IN_PROGRESS' | 'RESOLVED' | 'REJECTED')
                          }
                          className="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md"
                          required
                          disabled={isSubmitting}
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    <select
                                      ...
                                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
                                        handleStatusChange(feedback.id, e.target.value as 'OPEN' | 'IN_PROGRESS' | 'RESOLVED' | 'REJECTED')
                                      }
