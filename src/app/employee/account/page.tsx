	...
	return (
		<AnimatePresence>
			...
			>
				<div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
					...
					<div className="flex items-center gap-3">
						<motion.button
							...
							onClick={refreshData}
							className="flex items-center gap-2 rounded-lg border border-zinc-200 px-3 py-1.5 text-sm transition-all duration-300 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-800/50"
							disabled={isRefreshing}
							aria-label="Actualiser les données"
						>
							<ArrowPathIcon
								className={`h-4 w-4 text-zinc-500 dark:text-zinc-400 ${isRefreshing ? "animate-spin" : ""}`}
							/>
				...
				<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
					...
					>
						<motion.div
							...
							className="h-full"
						>
							<Card className="group relative h-full overflow-hidden border border-zinc-200 bg-background shadow-lg dark:border-zinc-800 dark:bg-zinc-900">
								...
								<CardContent className="relative z-10 space-y-4">
									<div className="space-y-2">
										<div className="group flex items-center justify-between border-b py-3 dark:border-zinc-800">
											<span className="text-zinc-500 dark:text-zinc-400">
												Nom
											</span>
											<span className="font-medium text-zinc-900 transition-colors group-hover:text-red-600 dark:text-white dark:group-hover:text-red-400">
												{userInfo.name}
											</span>
										</div>
										<div className="group flex items-center justify-between border-b py-3 dark:border-zinc-800">
				...
				>
					<Card className="group relative mt-6 overflow-hidden border border-zinc-200 bg-background shadow-lg dark:border-zinc-800 dark:bg-zinc-900">
						...
						<div className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-red-500/20 via-orange-500/20 to-amber-500/20 opacity-0 blur transition-all duration-1000 group-hover:opacity-100" />
						...
						<CardContent className="relative z-10">
							{userInfo.contractUrl ? (
								...
								<motion.div
									...
									className="space-y-4"
								>
									<div className="flex flex-col items-center gap-4 rounded-lg border border-zinc-200 bg-zinc-50 p-6 dark:border-zinc-700/50 dark:bg-zinc-800/50">
										<div className="relative">
											<DocumentIcon className="h-12 w-12 text-zinc-400 dark:text-zinc-500" />
											<motion.div
												animate={{
													opacity: [0.5, 1, 0.5],
													scale: [1, 1.1, 1],
												...
												className="absolute inset-0 -z-10 rounded-full bg-zinc-200 blur-md dark:bg-zinc-700"
											/>
										</div>
